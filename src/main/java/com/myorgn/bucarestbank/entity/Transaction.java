...
public class Transaction {
	...
	public String toString() {
		return "Transaction [id=" + id + ", account=" + account + ", transactionDate="
				+ transactionDate + ", isDebit=" + isDebit + ", transactionAmount="
				+ transactionAmount + ", transactionDescription=" + transactionDescription + "]";
	}
}
